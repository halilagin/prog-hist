...
export class ProgHistAnnotatedBinsWithClickBudget extends Component {
...
<div className="histscontainer">
  ...
  */
                ...
                <div>
                  ...
                  <div className="buttonsContainer">
                    ...
                    <div className="binBudgetContainer bg-warning">
                      <div className="distButtonTopTitle">Clicks (20)</div>
                      <div className="binBudgetInsideAlign">
                        <div >
                          <div className="ph_binBudget_txt_cntr" >
                            <input ref="txtClickBudget" defaultValue={this.state.clickBudget} className="ph_binBudget"  />
                          </div>
                        </div>
  ...
  increaseBinCount(){
    ...
    this.state.clickBudget -=1;
    this.refs.txtClickBudget.value =this.state.clickBudget;
  ...
  initData(){
    ...
    this.refs={txtBinsCount:null, txtInterval:null, txtBinCountGuess:null, txtClickBudget:null};
        this.state = null;
        this.state = {
